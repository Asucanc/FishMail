...
public class AlreadyDeleteActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.nav_start_mail:
                intent = new Intent(AlreadyDeleteActivity.this,StartMailActivity.class);
                startActivity(intent);
                break;
            ...
            case R.id.nav_trash_mail:
                intent = new Intent(AlreadyDeleteActivity.this,TrashActivity.class);
                startActivity(intent);
                break;
            case R.id.nav_send:
                intent = new Intent(AlreadyDeleteActivity.this,SendActivity.class);
                break;
